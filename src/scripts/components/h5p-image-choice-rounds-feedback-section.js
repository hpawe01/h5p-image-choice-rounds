...
import './h5p-image-choice-rounds-feedback-section.scss';
import Util from '../h5p-image-choice-rounds-util';

/** Class representing the content */
export default class ImageChoiceRoundsFeedbackSection {
  /**
   * @constructor
   *
  ...
  constructor(params = {}, callbacks = {}) {
    ...
    this.feedbackSection.classList.add('h5p-image-choice-rounds-feedback-section');

    this.scoreText = document.createElement('div');
    this.scoreText.classList.add('h5p-image-choice-rounds-score-text');
   ...
   */
  show() {
    this.feedbackSection.classList.remove('h5p-image-choice-rounds-display-none');
  }
   ...
   */
  hide() {
    this.feedbackSection.classList.add('h5p-image-choice-rounds-display-none');
  }
